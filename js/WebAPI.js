...
MK.WebAPI = {
    ...
    Action: {
        ///bound request
        getAddUsersToTeamTemplateRequest: function (entityName, entityId, teamtemplateId) {
            /// <summary>
            /// 
            /// </summary>
            /// <param name="entityName" type="String"></param>
            /// <param name="entityId" type="Guid"></param>
            /// <param name="teamtemplateId" type="Guid"></param>
            /// <returns type="Object"></returns>
            ...
            //    },
            //    TeamTemplate: { "teamtemplateid": teamtemplateId }
            //};

            var addUserToTeam = {};
            addUserToTeam["Record"] = {};
            addUserToTeam["Record"][entityName + "id"] = entityId;
            addUserToTeam["Record"]["@odata.type"] = "Microsoft.Dynamics.CRM." + entityName;
            addUserToTeam["TeamTemplate"] = { "teamtemplateid": teamtemplateId };
